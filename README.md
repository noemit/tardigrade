<p align="center">
  <img src="docs/images/logo.png" alt="Tardigrade" width="140" />
</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <img src="docs/images/agent-annotations.png" alt="Agent acting as a persona, with click targets and notes annotated on the page" />
      <p align="center"><em>Persona-driven exploration with click targets and per-step notes.</em></p>
    </td>
    <td width="50%" valign="top">
      <img src="docs/images/home.png" alt="Tardigrade home dashboard showing run count and system status" />
